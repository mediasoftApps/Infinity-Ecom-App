...
import 'package:infinity_ecom_app/data_model/category.dart';
import 'package:infinity_ecom_app/data_model/product_details_response.dart';
import 'package:infinity_ecom_app/data_model/product_mini_response.dart';
import 'package:infinity_ecom_app/data_model/variant_response.dart';
...
import 'package:infinity_ecom_app/data_model/wholesale_model.dart';
...
class ProductRepository {
  ...
  Future<ProductMiniResponse> getDigitalProducts({
    ...
    String url =
        ("${AppConfig.BASE_URL}/products/search?page=1&name=$name&sort_key=$sort_key&brands=$brands&categories=&min=$min&max=$max&digital=$page");

...
import 'package:infinity_ecom_app/data_model/refund_request_response.dart';
import 'package:infinity_ecom_app/data_model/refund_request_send_response.dart';
...
class RefundRequestRepository {
  ...
  Future<dynamic> getRefundRequestSendResponse({
    ...
    var postBody = jsonEncode({"id": "$id", "reason": reason});

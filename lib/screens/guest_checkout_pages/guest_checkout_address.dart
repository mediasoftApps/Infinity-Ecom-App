...
import 'package:infinity_ecom_app/repositories/guest_checkout_repository.dart';
import 'package:infinity_ecom_app/screens/checkout/shipping_info.dart';
...
class _GuestCheckoutAddressState extends State<GuestCheckoutAddress> {
  ...
  _onTapOpenAddressDialog() async {
    ...
    var hasStateData = (settingsResponse.data ?? []).firstWhere(
  ...
  Future<void> _continueToDeliveryInfo() async {
    ...
    if (guestCheckResponse.result!) {
      ...
      AIZRoute.push(
        context,
        ShippingInfo(guestCheckOutShippingAddress: jsonEncode(shippingAddress)),
      );
    }
  }

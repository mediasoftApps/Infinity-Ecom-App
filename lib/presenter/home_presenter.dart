...
import 'package:infinity_ecom_app/data_model/flash_deal_response.dart';
import 'package:infinity_ecom_app/data_model/slider_response.dart';
import 'package:infinity_ecom_app/repositories/category_repository.dart';
import 'package:infinity_ecom_app/repositories/flash_deal_repository.dart';
import 'package:infinity_ecom_app/repositories/product_repository.dart';
import 'package:infinity_ecom_app/repositories/sliders_repository.dart';
import 'package:infinity_ecom_app/single_banner/model.dart';
...
class HomePresenter extends ChangeNotifier {
  ...
  fetchFlashDealBannerImages() async {
    try {
      var flashDealBannerResponse = await SlidersRepository()
          .getFlashDealBanner();

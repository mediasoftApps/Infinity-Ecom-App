...
class AppConfig {
  ...
  static String app_name = "Infinity Ecom"; //this shows in the splash screen
  static String search_bar_text =
      "Search in Infinity Ecom..."; //this will show in app Search bar.
  ...
  static const DOMAIN_PATH =
      "36.255.71.72:196"; //use only domain name without http:// or https://
